...
1. GitHub Actions `AperiON DealerStatement Receivables` workflow ikinci run sonucu kontrol edilecek.
2. Artifact icindeki `dealer_statement_gmail_worker_report.json`, varsa `dealer_statement_finance_calendar_plan.json` ve `dealer_statement_finance_calendar_import_proof.json` incelenecek.
