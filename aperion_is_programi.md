...
- [ ] BizimHesap GitHub senkron akisi: masraf oturum yakalandiktan sonra calisacak sekilde sona alindi; son canli run bekleniyor

## Kirmizi - Kaldi

- [ ] GitHub Actions Hourly BizimHesap Sync son canli run: tek kalan masraf erken sirada giris hatasi; yeni siralama canli test edilecek
