...
const checks = [
  ...
  ['future receivable card label', html.includes('Gelecek Tahsilat BÃ¼tÃ§esi')],
  ...
  ['safe empty text', html.includes('DealerStatement raporu Finans Takvimi tablosuna alÄ±nmadÄ±')],
