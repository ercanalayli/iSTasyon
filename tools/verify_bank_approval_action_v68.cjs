...
const checks = [
  ...
  ['human confirmation meaning is visible', index.includes('bank-human-confirm') && index.includes('Onay anlamı')],
  ...
  ['home bank approval summary stats are visible', index.includes('bank-command-status-stats') && index.includes('Taranan') && index.includes('Güvenli aday') && index.includes('İnceleme') && index.includes('Kuyruk') && index.includes('Rapor')],
