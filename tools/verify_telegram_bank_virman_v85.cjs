...
const sample = classifyBankMovement({
  id: 'is-vakif-virman', bank_name: 'IS BANKASI', transaction_date: '2026-05-26', amount_out: 17300,
...
assert.equal(sample.plan.target_account, '*VAKIF SIRKET');
assert.match(sample.plan.confirmation_question, /\*VAKIF SIRKET/i);
