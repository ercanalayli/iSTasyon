...
const requiredFiles = [
  ...
  'finance/AperiON_Main_Financial_Statements_v53_Wireframe.md',
  ...
  'finance/AperiON_Financial_Statement_Engine_Runbook_v54.md',
  'finance/AperiON_Financial_Statement_Engine_v54.md',
  ...
  'tools/verify_financial_statement_engine_v54.js',
...
const requiredContent = [
  ...
  { file: 'finance/AperiON_Financial_Statement_Engine_SQL_v54.sql', text: 'finance_events_v54', label: 'v54 event tablosu' },
  { file: 'finance/AperiON_Financial_Statement_Engine_SQL_v54.sql', text: 'finance_ledger_v54', label: 'v54 ledger tablosu' },
  { file: 'finance/AperiON_Financial_Statement_Engine_SQL_v54.sql', text: 'finance_events_v54_after_write_trigger', label: 'v54 otomatik event trigger fonksiyonu' },
  { file: 'finance/AperiON_Financial_Statement_Engine_SQL_v54.sql', text: 'trg_finance_events_v54_after_insert_update', label: 'v54 otomatik event trigger' },
  { file: 'finance/AperiON_Financial_Statement_Engine_SQL_v54.sql', text: 'financial_income_statement_v54_view', label: 'v54 gelir tablosu view' },
  { file: 'finance/AperiON_Financial_Statement_Engine_SQL_v54.sql', text: 'financial_balance_sheet_v54_view', label: 'v54 bilanço view' },
  { file: 'finance/AperiON_Financial_Statement_Engine_SQL_v54.sql', text: 'financial_kpi_summary_v54_view', label: 'v54 KPI view' },
  { file: 'finance/AperiON_Financial_Statement_Engine_SQL_v54.sql', text: 'financial_reconciliation_alerts_v54_view', label: 'v54 alert view' },
  { file: 'preview/aperion_v53_financial_center_preview.html', text: 'financial_income_statement_v54_view', label: 'v53 preview gelir tablosu canlı view bağlantısı' },
  { file: 'preview/aperion_v53_financial_center_preview.html', text: 'financial_balance_sheet_v54_view', label: 'v53 preview bilanço canlı view bağlantısı' },
  { file: 'preview/aperion_v53_financial_center_preview.html', text: 'financial_kpi_summary_v54_view', label: 'v53 preview KPI canlı view bağlantısı' },
  { file: 'preview/aperion_v53_financial_center_preview.html', text: 'financial_reconciliation_alerts_v54_view', label: 'v53 preview alert canlı view bağlantısı' },
  { file: 'preview/aperion_v53_financial_center_preview.html', text: 'finance_events_v54', label: 'v53 preview event insert hedefi' },
  { file: 'preview/aperion_v53_financial_center_preview.html', text: 'ENABLE_PREVIEW_WRITES', label: 'v53 preview yazma güvenlik anahtarı' },
  { file: 'preview/aperion_v53_financial_center_preview.html', text: 'writesEnabled()', label: 'v53 preview yazma koruma fonksiyonu' },
  { file: 'preview/aperion_v53_financial_center_preview.html', text: 'source_table:\'v53_financial_preview_quick_action\'', label: 'v53 preview event kaynak etiketi' },
  { file: 'preview/aperion_v53_financial_center_preview.html', text: 'Demo Fallback', label: 'v53 preview güvenli fallback' },
  { file: 'preview/aperion_v53_financial_center_preview.html', text: 'Event → Ledger', label: 'v53 preview event-driven mimari etiketi' },
  { file: 'FINANCE_SETUP.md', text: 'v53 financial preview ekranını v54 view', label: 'v53/v54 canlı bağlantı kurulum rehberi' },
  { file: 'FINANCE_SETUP.md', text: 'financial_income_statement_v54_view', label: 'v54 view kurulum dokümantasyonu' },
  { file: 'FINANCE_SETUP.md', text: 'aperion-finans-config.js', label: 'gizli config dosyası dokümantasyonu' },
  ...
  { file: 'package.json', text: 'verify:financial-statement-engine-v54', label: 'v54 finansal tablo doğrulama script' },
