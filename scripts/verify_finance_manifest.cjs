...
const requiredFiles = [
  ...
  'finance/AperiON_Main_Financial_Statements_v53.md',
  'finance/AperiON_Zero_Keyboard_Interaction_v53.md',
...
const requiredContent = [
  ...
  { file: 'finance/AperiON_Main_Financial_Statements_v53.md', text: 'Dinamik Gelir Tablosu', label: 'v53 gelir tablosu ana ekran ilkesi' },
  { file: 'finance/AperiON_Main_Financial_Statements_v53.md', text: 'Dinamik Bilanço', label: 'v53 bilanço ana ekran ilkesi' },
  { file: 'finance/AperiON_Main_Financial_Statements_v53.md', text: 'Her satış, gider, tahsilat, ödeme', label: 'v53 işlem etkisi ana kuralı' },
  { file: 'finance/AperiON_Zero_Keyboard_Interaction_v53.md', text: 'Klavye ile iletişim en aza indirilecek', label: 'v53 zero keyboard ana ilke' },
  { file: 'finance/AperiON_Zero_Keyboard_Interaction_v53.md', text: 'Yazı yazdırma, seçenek sun', label: 'v53 seçenek odaklı UX ilkesi' },
  { file: 'finance/AperiON_Zero_Keyboard_Interaction_v53.md', text: 'Konuşarak', label: 'v53 konuşarak kullanım ilkesi' },
